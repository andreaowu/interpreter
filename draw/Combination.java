...
abstract class Combination extends Expr {
    ...
    abstract Expr create(List<Expr> operands) throws MyException;

    /** Return a new Combination of the type corresponding to the operator
     *  OPER, and having OPERANDS as its operands. */
    static Expr create(String oper, List<Expr> operands) throws MyException {
        Symbol s = new Symbol(oper);
        return s.create(operands);
    }
