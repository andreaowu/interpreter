 ...
 * @author Andrea Wu
 */
class FilledRect extends Picture {
    ...
    void draw(PrintWriter out) {
        ...
        out.println(_x4 + " " + _y4 + " lineto fill");
    }
    ...
    Picture move(double x, double y) {
        double a = _x1 + x;
        double b = _y1 + y;
        return new FilledRect(a, b, _w, _h, _rgb, _lw);
    }
    ...
    Picture rotate(double degree) {
        ...
        return new FilledRect(_x1, _y1, _w, _h, a, b, _rgb, _lw);
    }
    ...
    Picture scale(double factor) {
        ...
        double c = _w * factor;
        double d = _h * factor;
        return new FilledRect(a, b, c, d, _rgb, _lw);
    }
}
